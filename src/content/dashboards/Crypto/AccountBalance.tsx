...
const AvatarSuccess = styled(Avatar)(
  ({ theme }) => `
      background-color: KES {theme.colors.success.main};
      color: KES {theme.palette.success.contrastText};
      width: KES {theme.spacing(8)};
      height: KES {theme.spacing(8)};
      box-shadow: KES {theme.colors.shadows.success};
`
);
...
function AccountBalance() {
  ...
  const chartOptions: ApexOptions = {
    ...
    labels: ['Bets', 'Deposits', 'Withdrawals'],
    legend: {
      labels: {
        colors: theme.colors.alpha.trueWhite[100]
      },
          ...
          <Box p={4}>
            ...
            <Box>
              ...
              >
                ...
                <Box>
                  <Typography variant="h4">+ KES 2,893,594.00</Typography>
